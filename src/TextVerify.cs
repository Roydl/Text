...
{
    /// <summary>
    ///     Provides static methods of doing some checks on a character.
    /// </summary>
    public static class TextVerify
    {
        ...
        /// </param>
        /// <returns>
        ///     <see langword="true"/> if <paramref name="ch"/> is ASCII; otherwise,
        ///     <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        ///     Indicates whether the specified character is categorized as Latin-1
        ///     (ISO-8859-1).
        /// </summary>
        /// <param name="ch">
        ///     The character to evaluate.
        /// </param>
        /// <returns>
        ///     <see langword="true"/> if <paramref name="ch"/> is Latin-1 (ISO-8859-1);
        ...
        /// </param>
        /// <returns>
        ///     <see langword="true"/> if <paramref name="ch"/> is a ASCII letter;
        ///     otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        ///     Indicates whether the specified character is categorized as an Latin-1
        ///     (ISO-8859-1) letter.
        /// </summary>
        /// <param name="ch">
        ///     The character to evaluate.
        /// </param>
        /// <returns>
        ///     <see langword="true"/> if <paramref name="ch"/> is a Latin-1 (ISO-8859-1)
        ///     letter; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        ///     <see langword="true"/> if <paramref name="ch"/> is a line separator;
        ///     otherwise, <see langword="false"/>.
        /// </returns>

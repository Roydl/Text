namespace Roydl.Text
{
    ...
    /// <summary>Provides static methods for converting text.</summary>
    public static class TextConvert
    {
        /// <summary>Rotates all ASCII letters of the specified text by 13 characters.</summary>
        ...
        /// <returns>A converted ASCII letter or the original character.</returns>
        ...
        /// <summary>Converts all line separator characters of the specified input stream into the specified output stream.</summary>
        /// <param name="inputStream">The input stream to convert.</param>
        /// <param name="outputStream">The output stream for converting.</param>
        /// <param name="separator">The new format to be applied.</param>
        /// <param name="maxInRow">The maximum number of separators in a row. If the value is 0, all separators are removed, if it is negative, this function is ignored.</param>
        ...
        /// <summary>Converts all line separator characters of the specified source file to the specified destination file.</summary>
        /// <param name="srcPath">The source file to convert.</param>
        ...
        /// <summary>Converts all line separator characters of the specified string.</summary>
